  ...
  var result = {
    ...
    parse: function(input, startRule) {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column, seq) { return seq; })(pos0.offset, pos0.line, pos0.column, result0[0]);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
              if (result0 === null) {
                ...
                if (result0 !== null) {
                  result0 = (function(offset, line, column, map) { return map; })(pos0.offset, pos0.line, pos0.column, result0[0]);
                }
                if (result0 === null) {
                  pos = clone(pos0);
                }
      ...
      function parse_keyword() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, char) { return new ASTNode("keyword", char, line, column); })(pos0.offset, pos0.line, pos0.column, result0[0]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
