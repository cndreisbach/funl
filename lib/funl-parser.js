  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_expression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, left, right) { return new ASTNode("application", [left, right], line, column); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[3]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_valid_char() {
        ...
        if (result0 === null) {
          result0 = parse_special_char();
          if (result0 === null) {
            if (/^[0-9_?!=@#$%^&]/.test(input.charAt(pos.offset))) {
              result0 = input.charAt(pos.offset);
              advance(pos, 1);
            } else {
              result0 = null;
